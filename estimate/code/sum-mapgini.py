...
##################### Paths #####################
#################################################
OUTDIR   = os.path.join(os.path.dirname(__file__), "..", "output", "figs")
CACHEDIR = os.path.join(os.path.dirname(__file__), "..", "input")
...
input_path = os.path.join(os.path.dirname(__file__), "..", "input", "enigh-year.dta")
