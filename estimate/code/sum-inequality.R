...
ggsave("../output/figs/sum-centile-ictpc.png", width = 10, height = 6)
...
ggplot() +
  ...
  theme_minimal() +
  theme(legend.position = "bottom", legend.title = element_blank())
ggsave("../output/figs/sum-centile-total.png", width = 10, height = 6)
...
ggplot() +
  ...
  theme_minimal() +
  theme(legend.position = "bottom", legend.title = element_blank())
ggsave("../output/figs/sum-proportion-top.png", width = 10, height = 6)
...
ggplot(lorenz_plot_data, aes(x = p, y = lorenz, color = year)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom", legend.title = element_blank())
ggsave("../output/figs/sum-lorenz.png", width = 10, height = 6)

# NOTE: State-level Gini map is now generated by sum-mapgini.py (Python)

message("✓ Saved inequality plots to ../output/figs/")
