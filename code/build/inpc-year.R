...
json_file <- "../../data/source/inpc/inpc.json"
...
if (!dir.exists("../../data/clean/inpc")) dir.create("../../data/clean/inpc", recursive = TRUE)

write.csv(inpc, "../../data/clean/inpc/inpc.csv", row.names = FALSE)
