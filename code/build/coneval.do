...
Todas las bases de datos de la ENIGH 2022 deben estar en formato *.dta
...
3) Bitácoras: "C:\Pobreza 2022\log"

Para cambiar estas ubicaciones, se modifican los siguientes globals (gl); 

gl data="C:\Pobreza 2022\Bases de datos";
gl bases="C:\Pobreza 2022\Bases";
gl log="C:\Pobreza 2022\Log";
...
save "$bases\ic_cev22.dta", replace;
...
save "$bases\ic_sbv22.dta", replace;
...
save "$bases\menores22.dta", replace;
...
sort folioviv foliohog;
merge folioviv foliohog using "$bases\menores22.dta";
tab _merge;
drop _merge;
...
save "$bases\ic_ali22.dta", replace;
...
merge folioviv foliohog using "$bases\ic_cev22.dta";
tab _merge;
drop _merge;
sort folioviv foliohog;

merge folioviv foliohog using "$bases\ic_sbv22.dta";
tab _merge;
drop _merge;
sort folioviv foliohog;

merge folioviv foliohog using "$bases\ic_ali22.dta";
tab _merge;
drop _merge;
sort folioviv foliohog;
...
sort folioviv foliohog numren;
save "$bases\pobreza_22.dta", replace;
